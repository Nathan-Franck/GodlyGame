...
declare module godot {
	...
	class Node3D<T = any> extends Node<T> {
		get_position(): Vector3;
		set_position(position: Vector3): void;
		get_rotation(): Vector3;
		set_rotation(rotation: Vector3): void;
	}
	class Node2D<T = any> extends Node<T> {
	}
	class Sprite2D {
	}
...
declare module godot {
	...
	class Quaternion {
		...
		cubic_slerp(b: Quaternion, pre_a: Quaternion, post_b: Quaternion, t: number): Quaternion;
		...
		/**  */
		is_equal_approx(quat: Quaternion): boolean;
		...
		slerpni(b: Quaternion, t: number): Quaternion;
