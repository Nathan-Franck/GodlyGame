...
async function parseBlend(filePath) {
    ...
    // Read header
    const expected = "BLENDER";
    const header = new Uint8Array(data.buffer, 0, 7);
    const headerStr = String.fromCharCode(...header);
    if (headerStr !== expected) {
        throw new Error(`Invalid blend file header. Expected ${expected}, got ${headerStr}`);
    }
    return "good!";
}
;
...
//         "use strict";
//         var data: DataView | null  = null,
//             BIG_ENDIAN = false,
//             pointer_size = 0,
//             struct_names: string[] = [],
//             offset = 0,
//             working_blend_file = null,
//             current_SDNA_template: typeof MASTER_SDNA_SCHEMA | null = null,
//             templates: Record<string, typeof MASTER_SDNA_SCHEMA> = {},
//             finished_objects = [],
//             FILE: typeof BLENDER_FILE | null = null,
//             AB = null;
